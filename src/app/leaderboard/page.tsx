...
const MEDALS = ["text-gold-300", "text-bone-300", "text-flag-amber"];
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
                ...
                <li key={p.id}>
                  ...
                  >
                    ...
                    <span className="hidden shrink-0 text-right sm:block">
                      ...
                      <span className="block text-xs text-bone-500">{p.win_pct}%</span>
                    </span>
      ...
      <p className="text-center text-xs text-bone-600">
        ...
        <Badge tone="gold">2.0</Badge> is where everyone starts.
      </p>
    </div>
  );
}
