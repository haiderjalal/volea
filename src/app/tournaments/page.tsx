            ...
            return (
              <li key={t.id}>
                <Link href={`/tournaments/${t.slug}`} className="block h-full">
                  <Card className="h-full p-4 transition-colors hover:border-court-600">
                    <div className="flex items-start justify-between gap-3">
                      <h2 className="text-base font-semibold text-chalk-100">{t.name}</h2>
                    ...
                    <dl className="mt-4 space-y-1.5 text-xs text-chalk-500">
                    ...
                    <p className="mt-4 text-sm font-semibold text-ball-400">
                      {t.entry_fee_cents > 0
